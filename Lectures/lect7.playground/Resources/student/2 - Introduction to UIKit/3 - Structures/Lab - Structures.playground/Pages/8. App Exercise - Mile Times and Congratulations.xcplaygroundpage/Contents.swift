...
struct RunningWorkout {
    ...
    var averageMileTime: Double {
        return time / (distance / 1600) //Computed Property
    }
}
let w1 = RunningWorkout(distance: 2500, time: 60, elevation: 100)
print(w1.averageMileTime)
/*:
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print("Congraulations! You reached your goal!")
            }
        }
    }
    var goal: Int
