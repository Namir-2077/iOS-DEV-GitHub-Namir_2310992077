...
struct Height {
    ...
    var heightInCentimeters: Double {
        didSet {
            let expectedInches = heightInInches / 2.54
...
print("Initial centimeters: \(height.heightInCentimeters)")

height.heightInInches = 72
print("Updated centimeters: \(height.heightInCentimeters)")

height.heightInCentimeters = 160
print("Updated inches: \(height.heightInInches)")
/*:
