...
var User1 = User(name: "John", age: 30, height: 1.78, weight: 70, activityLevel: 7)
print(User1.name)
print(User1.age)
print(User1.height)
print(User1.weight)
print(User1.activityLevel)
/*:
