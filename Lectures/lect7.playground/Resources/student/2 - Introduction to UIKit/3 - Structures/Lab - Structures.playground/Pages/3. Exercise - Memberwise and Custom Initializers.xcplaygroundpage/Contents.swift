...
var favoriteBook = Book(title: "Dr. No", author: "Ian Fleming", pages: 320, prices: 11.99)
print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author). It has \(favoriteBook.pages) pages. It is priced at $\(11.99).")
/*:
...
var P1 = Laptop(yearPurchased: 2022)
var P2 = Laptop(yearPurchased: 2021)
/*:
...
let h1 = Height(inches: 65)
print(h1.heightInCentimeters)

let h2 = Height(centimeters: 165.1)
print(h2.heightInInches)
...
func convertToInches(_ centimeters: Double) -> Double {
