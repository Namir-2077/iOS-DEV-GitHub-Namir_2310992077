...
struct User {
        ...
        static var currentUser = User(userName: "DefaultUser", email: "default@example.com", age: 25)
 ...
 */
let firstUser = User(userName: "Maximus", email: "maximus@example.com", age: 28)
let secondUser = User(userName: "Julius", email: "bob@example.com", age: 34)
