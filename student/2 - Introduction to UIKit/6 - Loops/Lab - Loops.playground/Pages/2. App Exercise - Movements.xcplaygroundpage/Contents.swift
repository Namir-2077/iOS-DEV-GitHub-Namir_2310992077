...
for typeOfMovement in movements {
    print("The Type Of Movement: \(movements)")
}
...
for (typeOfMovement, heartRate) in movementHeartRates {
    print("The Type Of Movement: \(movements) and heart rate during the Movement: \(heartRate)")
}
/*:
